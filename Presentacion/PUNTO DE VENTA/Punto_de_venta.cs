...
namespace sisgeres.Presentacion.PUNTO_DE_VENTA
{
    ...
    public partial class Punto_de_venta : UserControl
    {
        ...
        private void EventoDelegado()
        {
            ...
            btneliminarVenta.Click += new EventHandler((sender, args) =>
            {
                GuardarClick?.Invoke(this, null);
            });
            Bn1.Click += new EventHandler((sender, args) =>
            {
                GuardarClick?.Invoke(this, null);
            });
            Bn5.Click += new EventHandler((sender, args) =>
            {
                GuardarClick?.Invoke(this, null);
            });
            Bn10.Click += new EventHandler((sender, args) =>
            {
                GuardarClick?.Invoke(this, null);
            });
            Bn20.Click += new EventHandler((sender, args) =>
            {
                GuardarClick?.Invoke(this, null);
            });
            Bn50.Click += new EventHandler((sender, args) =>
            {
                GuardarClick?.Invoke(this, null);
            });
            Bn100.Click += new EventHandler((sender, args) =>
            {
                GuardarClick?.Invoke(this, null);
            });
            BnExacto.Click += new EventHandler((sender, args) =>
            {
                GuardarClick?.Invoke(this, null);
            });
        ...
        private void btnDividirCuenta_Click(object sender, EventArgs e)
        {
            ...
            var frm = new VisorDecuentas();
            frm.volverClick += Frm_Click;
            frm.Dock = DockStyle.Fill;
            this.Controls.Add(frm);
            frm.BringToFront();
        }
