...
namespace sisgeres.Presentacion.PRODUCTOS
{
    public partial class Productos_rest : UserControl
    {
        ...
        private void ToolStripEDITAR_Click(object sender, EventArgs e)
        {
            ...
            frm.guardarClick += UsrCtrl_OnButtonClick;
            frm.cerrarClick += Frm_cerrarClick;
        ...
        private void ToolStripEDITAR_Click1(object sender, EventArgs e)
        {
            ...
            frm.guardarClick += frmRegistroProducto_FormClosed;
            frm.cerrarClick += Frm_cerrarClick;
            frm.Dock = DockStyle.Fill;
            this.Controls.Add(frm);
            frm.BringToFront();
        ...
        private void Frm_cerrarClick(object sender, EventArgs e)
        {
            panel1.Visible = true;
        }
        ...
        public void frmRegistroProducto_FormClosed(object sender, EventArgs e)
        {
            panel1.Visible = true;
            dibujarProductos();
        }
