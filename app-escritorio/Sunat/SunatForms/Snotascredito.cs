...
{
    public partial class Snotascredito : UserControl
    {
        public Snotascredito()
        {
            InitializeComponent();
        }
        ...
        private void Snotascredito_Load(object sender, EventArgs e)
        {
            BuscarNotascredito();
        }
        private void BuscarNotascredito()
        {
            PanelNcredito.Controls.Clear();
            var funcion = new Dnotascredito();
            var dt = new DataTable();
            funcion.buscarNotascredito(ref dt,txtbuscar.Text);
